...
- Homeworks, Reading Quizzes, and Activities due on regular schedule EXCEPT...
  - Activity: Markdown Schedule due Friday, September 16th at 11:59 pm
  - Extra credit due Wednesday, September 21st at 11:59 pm

- This we we have an intro to graphing in R
- The next 2 weeks we will talk about preparing our data to graph using the `tidyverse` package
- We will then return to graphing

### Reminders ... 

- Extra credit
- Read the announcement I sent over the weekend to get a step-by-step guide for connecting GitHub and RStudio
- Once you connect GitHub and RStudio, you can "pull" the class notes to your own computer (see the step-by-step guide)
